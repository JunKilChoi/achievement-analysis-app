...
BASIC_INDIVIDUAL_FOCUS_PRESETS: Dict[str, str] = {
    ...
    "학생 맞춤형 피드백 문장 제안": "선택한 학생의 평가 결과를 바탕으로 학생에게 제공할 수 있는 맞춤형 피드백을 제안해 주세요. 단순히 점수를 설명하기보다, 강점, 보완할 개념, 다시 풀어볼 문항 유형, 다음 학습 방향이 드러나도록 구체적으로 작성해 주세요.",
    ...
    "다음 시험 준비를 위한 학습 전략 조언": "선택한 학생이 다음 시험을 준비할 때 활용할 수 있는 학습 전략을 중심으로 조언해 주세요. 이번 평가에서 드러난 강점과 취약점을 바탕으로, 우선 복습해야 할 개념, 다시 풀어볼 문항 유형, 오답 정리 방법, 시험 준비 순서와 시간 배분 방향을 구체적으로 제안해 주세요.",
